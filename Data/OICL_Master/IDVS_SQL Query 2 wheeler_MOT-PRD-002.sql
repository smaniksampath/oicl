...
-- import csv file into motor_idvs_temp_2 table.
...
SELECT MAX(ID) FROM `motor_variant`;  -- 6686016
UPDATE `motor_idvs_temp_2` SET col_32 = 6686016 + col_32;
...
SELECT * FROM motor_variant WHERE ID>6686016;

-- Step 7: update id and reconfurm through above query that record is updated
UPDATE motor_variant m SET m.id=m.idvs_id WHERE m.idvs_id>6686016;
...
SELECT * FROM motor_relations WHERE create_date LIKE '%2022-09-21%' LIMIT 4000;

-- Step 10: chenge date and run query for 2 weelar. 
INSERT INTO motor_relations(cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,productid,PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,CREATE_DATE,UPDATE_DATE,IS_ACTIVE,stateid)
 SELECT cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,'247' AS productid,'MOT-PRD-013' AS PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,NOW() AS CREATE_DATE,NOW() AS UPDATE_DATE,IS_ACTIVE,stateid FROM motor_relations WHERE productid=189 AND create_date='2022-09-21 17:10:14' ;

-- Step 11: chenge date and run query for SAOD TWO Wheeler. 
INSERT INTO motor_relations(cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,productid,PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,CREATE_DATE,UPDATE_DATE,IS_ACTIVE,stateid)
 SELECT cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,'247' AS productid,'MOT-PRD-016' AS PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,NOW() AS CREATE_DATE,NOW() AS UPDATE_DATE,IS_ACTIVE,stateid FROM motor_relations WHERE productid=189 AND create_date='2022-09-21 17:10:14' ;

-- Step 12: chenge date and run query for SA CPA TWO Wheeler. 
INSERT INTO motor_relations(cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,productid,PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,CREATE_DATE,UPDATE_DATE,IS_ACTIVE,stateid)
 SELECT cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,'247' AS productid,'MOT-PRD-014' AS PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,NOW() AS CREATE_DATE,NOW() AS UPDATE_DATE,IS_ACTIVE,stateid FROM motor_relations WHERE productid=189 AND create_date='2022-09-21 17:10:14' ;

-- Step 13: chenge date and run query for POSP Motorised Two Wheelers. 
INSERT INTO motor_relations(cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,productid,PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,CREATE_DATE,UPDATE_DATE,IS_ACTIVE,stateid)
 SELECT cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,'247' AS productid,'MOT-POS-011' AS PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,NOW() AS CREATE_DATE,NOW() AS UPDATE_DATE,IS_ACTIVE,stateid FROM motor_relations WHERE productid=189 AND create_date='2022-09-21 17:10:14' ;

-- Step 14: chenge date and run query for POS-MOTORISED TWO WHEELERS. 
INSERT INTO motor_relations(cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,productid,PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,CREATE_DATE,UPDATE_DATE,IS_ACTIVE,stateid)
 SELECT cityid,CITY_NAME,mfgid,MANUFACTURER_NAME,'247' AS productid,'MOT-POS-013' AS PRODUCT_NAME,modelid,MODEL_NAME,variantid,VARIANT_NAME,NOW() AS CREATE_DATE,NOW() AS UPDATE_DATE,IS_ACTIVE,stateid FROM motor_relations WHERE productid=189 AND create_date='2022-09-21 17:10:14' ;
